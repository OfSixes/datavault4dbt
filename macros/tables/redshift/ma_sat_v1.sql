...
end_dated_source AS (
    ...
    {%- endif %}
        {{ datavault4dbt.print_list(ma_attributes, indent=0, src_alias='src') | indent(8) }},
        {{ datavault4dbt.print_list(source_columns_to_select, indent=0, src_alias='src') | indent(8) }}
